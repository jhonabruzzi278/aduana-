import { showToast } from './toast'; // Asumiendo que toast.ts está en la misma carpeta o una carpeta padre
import { guardarTramite } from './storage'; // Si quieres guardar el resultado de la validación
